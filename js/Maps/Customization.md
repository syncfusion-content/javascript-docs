...
{% highlight javascript %}
        ...
        var electionData = [
            ...
            { State: "California", Candidate: "Barack Obama", Electors: 55 }, 
            { State: "Colorado", Candidate: "Barack Obama", Electors: 9 }, 
            { State: "Connecticut", Candidate: "Barack Obama", Electors: 7 }, 
            { State: "Delaware", Candidate: "Barack Obama", Electors: 3 }, 
            { State: "District of Columbia", Candidate: "Barack Obama", Electors: 3 }, 
            { State: "Florida", Candidate: "Barack Obama", Electors: 29 }, 
            { State: "Georgia", Candidate: "Romney", Electors: 16 }, 
            { State: "Hawaii", Candidate: "Barack Obama", Electors: 4 }, 
            { State: "Idaho", Candidate: "Romney", Electors: 4 }, 
            { State: "Illinois", Candidate: "Barack Obama", Electors: 20 }, 
            { State: "Indiana", Candidate: "Romney", Electors: 11 }, 
            { State: "Iowa", Candidate: "Barack Obama", Electors: 6 }, 
            ...
            { State: "Maine", Candidate: "Barack Obama", Electors: 4 }, 
            { State: "Maryland", Candidate: "Barack Obama", Electors: 10 },     
            { State: "Massachusetts", Candidate: "Barack Obama", Electors: 11 }, 
            { State: "Michigan", Candidate: "Barack Obama", Electors: 16 }, 
            { State: "Minnesota", Candidate: "Barack Obama", Electors: 10 }, 
            ...
            { State: "Nevada", Candidate: "Barack Obama", Electors: 6 }, 
            { State: "New Hampshire", Candidate: "Barack Obama", Electors: 4 }, 
            { State: "New Jersey", Candidate: "Barack Obama", Electors: 14 }, 
            { State: "New Mexico", Candidate: "Barack Obama", Electors: 5 },     
            { State: "New York", Candidate: "Barack Obama", Electors: 29 }, 
            { State: "North Carolina", Candidate: "Romney", Electors: 15 }, 
            { State: "North Dakota", Candidate: "Romney", Electors: 3 }, 
            { State: "Ohio", Candidate: "Barack Obama", Electors: 18 }, 
            { State: "Oklahoma", Candidate: "Romney", Electors: 7 }, 
            { State: "Oregon", Candidate: "Barack Obama", Electors: 7 }, 
            { State: "Pennsylvania", Candidate: "Barack Obama", Electors: 20 }, 
            { State: "Rhode Island", Candidate: "Barack Obama", Electors: 4 }, 
            ...
            { State: "Vermont", Candidate: "Barack Obama", Electors: 3 }, 
            { State: "Virginia", Candidate: "Barack Obama", Electors: 13 }, 
            { State: "Washington", Candidate: "Barack Obama", Electors: 12 }, 
            { State: "West Virginia", Candidate: "Romney", Electors: 5 }, 
            { State: "Wisconsin", Candidate: "Barack Obama", Electors: 10 }, 
                    ...
                    {                            
                        ...
                        {                                
                            ...
                            [                                    
                                ...
                                { value: "Barack Obama", color: "#316DB5" }                                
                            ]                            
                        }                        
                    }                    
                }]            
