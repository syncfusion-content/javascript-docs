...
The shape layers is the core layer of the map. The multiple layers can be added in the shape layers as [`subLayers`](../api/ejmap#members:layers-sublayers) within the shape layers.
