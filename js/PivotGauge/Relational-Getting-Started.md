...
N> The above "GettingStarted.html" contains WebAPI URL, which is **“/RelationalGauge”**. Suppose if you are using WCF service then the URL would look like **"/RelationalGaugeService.svc"**. 

### WebAPI

**Adding a WebAPI Controller**

To add a WebAPI controller in your existing Web Application, right-click on the project in Solution Explorer and select **Add > New Item**. In the **Add New Item** window, select **WebAPI Controller Class** and name it as “RelationalGaugeController.cs”, click **Add**.
