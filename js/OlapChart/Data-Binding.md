...
**OlapChart** control enables you to retrieve multidimensional data either from **Microsoft SQL Server Analysis Services(SSAS)** or through any **XML/A** provider and present the OLAP information in a meaningful way.
