...
{% include image.html url="/js/Accordion/Appearance-and-Styling_images/Appearance-and-Styling_img1.png" Caption="Accordion height set to auto adjust mode"%}
...
{% include image.html url="/js/Accordion/Appearance-and-Styling_images/Appearance-and-Styling_img2.png" Caption="Accordion with Rounded rectangular appearance"%}
...
{% include image.html url="/js/Accordion/Appearance-and-Styling_images/Appearance-and-Styling_img3.png" Caption="Accordion with customized icons"%}
...
{% include image.html url="/js/Accordion/Appearance-and-Styling_images/Appearance-and-Styling_img4.png" Caption="Accordion with Custom CSS property"%}
