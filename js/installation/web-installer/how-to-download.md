...
8. After downloading, the Syncfusion JavaScript web installer can be unlocked using Syncfusion registered login credential.
...
You can also refer to the [**Web installer**](https://help.syncfusion.com/js/installation/web-installer/how-to-install) links for step-by-step installation guidelines.	
