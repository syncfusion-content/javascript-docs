...
# Downloading Syncfusion JavaScript offline installer
...
6. Click the More Download Options (element 2 in the above screenshot) button to get the Essential Studio JavaScript Offline trial installer which is available in EXE and ZIP format.
...
You can also refer to the [**Offline installer**](https://help.syncfusion.com/js/installation/offline-installer/how-to-install) links for step-by-step installation guidelines.	
