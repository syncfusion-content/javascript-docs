---
layout: post
title: Installation process for Syncfusion JavaScript products
description: This section provides information regarding the Syncfusion JavaScript Online installer and steps for installing it
platform: js
...
The steps below show how to install Essential Studio JavaScript Web Installer.

1.  Open the Syncfusion Essential Studio JavaScript Web Installer file from downloaded location by double-clicking it. The Installer Wizard automatically opens and extracts the package.

    ![Installer Extraction Wizard](WebInstaller/Step-by-Step-Installation_img1.png)

    
    N> The installer wizard extracts the syncfusionessentialjavascript-js1webinstaller_{version}.exe dialog, which displays the package's unzip operation.
    
2. 	The Syncfusion JavaScript Web Installer's welcome wizard will be displayed. Click the Next button.
...
Syncfusion JavaScript installer can be uninstalled in two ways.

   * Uninstall the JavaScript using the Syncfusion JavaScript web installer
   * Uninstall the JavaScript from Windows Control Panel

Follow either one of the option below to uninstall Syncfusion Essential Studio JavaScript installer.
  
**Option 1: Uninstall the JavaScript using the Syncfusion JavaScript web installer**
...
Open the Syncfusion Essential Studio JavaScript Online Installer file from downloaded location by double-clicking it. The Installer Wizard automatically opens and extracts the package

![Installer Extraction Wizard uninstall](WebInstaller/Step-by-Step-Installation_img1.png)
	
The Syncfusion JavaScript Web Installer's welcome wizard will be displayed. Click the Next button
	
![Welcome wizard uninstall](WebInstaller/Step-by-Step-Installation_img2.png)
	
	
**Option 2: Uninstall the JavaScript from Windows Control Panel**  
	
You can uninstall all the installed products by selecting the **Syncfusion Essential Studio {version}** entry (element 1 in the below screenshot) from the Windows control panel, or you can uninstall JavaScript alone by selecting the **Syncfusion Essential Studio for JavaScript {version}** entry (element 2 in the below screenshot) from the Windows control panel.

![Control Panel](WebInstaller/Step-by-Step-Installation_img22.png)
	
N> If the **Syncfusion Essential Studio for JavaScript {version}** entry is selected from the Windows control panel, the Syncfusion Essential Studio JavaScript alone will be removed and the below default MSI uninstallation window will be displayed.	
