...
The following procedure illustrates how to install Essential Studio for JavaScript Online Installer. 

1.  Double-click the Syncfusion JavaScript Online Installer setup file. The Setup Wizard opens and extracts the package automatically.

    ![](WebInstaller/Step-by-Step-Installation_img1.png)

    
    N> The Setup wizard extracts the syncfusionjavascriptwebinstaller_{version}.exe dialog, displaying the unzip operation of the package.
