...
Also you can get the text value by using [getText](https://help.syncfusion.com/api/js/ejtreeview#methods:gettext) method.
...
You can use [addNodes](https://help.syncfusion.com/api/js/ejtreeview#methods:addnodes) to add a collection of nodes in TreeView.
...
You can directly edit the tree node’s text in-place by double-click on the tree node or select the tree node and press F2 key. The editing works only if the [allowEditing](https://help.syncfusion.com/api/js/ejtreeview#members:allowediting) property is true in TreeView control. When editing is completed by focus out or “enter” key press, the modified node’s text is saved automatically. [nodeEdit]((https://help.syncfusion.com/api/js/ejtreeview#events:nodeedit)) event will be trigger whenever editing the TreeView node.
Also [beforeEdit]((https://help.syncfusion.com/api/js/ejtreeview#events:beforeedit)) event will be trigger when before editing the Treeview node.
...
To get the selected status of a given TreeView node you have to use [isSelected](https://help.syncfusion.com/api/js/ejtreeview#methods:isselected) method. The [nodeSelect](https://help.syncfusion.com/api/js/ejtreeview#events:nodeselect) event will be trigger when TreeView node is selected.
The [nodeUnselect](https://help.syncfusion.com/api/js/ejtreeview#events:nodeunselect) event will be trigger when the TreeView node is unselected. The [beforeSelect](https://help.syncfusion.com/api/js/ejtreeview#events:beforeselect) event will be trigger when TreeView node is before selected.
The [nodeClick](https://help.syncfusion.com/api/js/ejtreeview#events:nodeclick) event will be trigger whenever TreeView node is clicked.
...
Also you have to use [getVisibleNodes](https://help.syncfusion.com/api/js/ejtreeview#methods:getvisiblenodes) method to get currently visible nodes in TreeView.
