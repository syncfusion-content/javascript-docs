...
<tr>
<td>
<b>[JavaScript]</b>// Set enablePersistence to “True” for TreeView control.            $("#treeView").ejTreeView(                {                    enablePersistence: true                });</td></tr>
</table>


The output for **TreeView** when **enablePersistence** is set to **True** is as follows.

{% include image.html url="/js/TreeView/Concepts-and-Features/Node-Persistence-Handling_images/Node-Persistence-Handling_img1.png" Caption="TreeView with enablePersistence"%}
