...
{% include image.html url="/js/TreeView/Getting-Started_images/Getting-Started_img1.png" Caption="TreeView "%}
...
{% highlight js %}
    ...
    $(function () {            
        ...
        $("#mailboxTree").ejTreeView({                    
            // mapping JSON Data Source with the fields property of TreeView 
            fields: { id: "id", parentId: "pid", text: "name", hasChild: "hasChild", dataSource: outlookicons, expanded: "expanded" },                    
            allowEditing : true     // Setting TreeNode Editing option to true
        });
...
{% highlight js %}
    ...
    $(function () {            
        ...
        $("#mailboxTree").ejTreeView({                    
            ...
            fields: { id: "id", parentId: "pid", text: "name", hasChild: "hasChild", dataSource: outlookicons, expanded: "expanded" },            
            allowEditing: true,         // Setting TreeNode Editing option to true            
            allowDragAndDrop: true      // Setting TreeView Drag and Drop option to true
