...
TreeView support all possible keyboard interaction and it can be allowed by specifying [allowKeyboardNavigation](http://help.syncfusion.com/js/api/ejtreeview#members:allowkeyboardnavigation) as true.
