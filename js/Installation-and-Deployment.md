...
The steps to configure the Syncfusion JavaScript NuGet Packages in Visual Studio are as follows,
...
4. Select the platform **JavaScript** from **“Select platforms to add”** (Left side of the window) column and click **Add>>** button. Then click **Configure** button.
