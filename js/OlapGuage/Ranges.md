...
{% include image.html url="/js/OlapGauge/Ranges_images/Ranges_img1.png" Caption="Range style customization"%}
...
{% include image.html url="/js/OlapGauge/Ranges_images/Ranges_img2.png" Caption="Range Size Setting"%}
