...
On excuting the above mentioned codes will render the same output as follows.
 ...
 ![]("/js/Schedule/Priority_images/Priority_img2.png" Caption="Pop-up dialog with list of priorities available")


![]("/js/Schedule/Priority_images/Priority_img3.png" Caption="schedule with customised priority.")
