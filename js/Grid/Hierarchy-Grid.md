...
If the foreign key column name differs for parent and child grid then use `childGrid.foreignKeyField` property of child grid. Refer [here](https://help.syncfusion.com/js/grid/how-to#hierarchy-grid-with-different-foreignkeyfield-in-parent-and-child-table "here") for more information.
