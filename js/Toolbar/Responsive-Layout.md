...
http://cdn.syncfusion.com/13.1.0.21/js/web/responsive-css/ej.responsive.css
...
{% include image.html url="/js/Toolbar/Responsive-Layout_images/Responsive-Layout_img1.png" Caption="Toolbar with Responsive Support"%}
