---
layout: post
title: Upgrading Syncfusion JavaScript installer to a latest version - Syncfusion
description: Learn here about the how upgrade Syncfusion JavaScript installer to a latest version from website and control panel.
platform: js
control: Essential Studio
documentation: ug
---

# Upgrading Syncfusion JavaScript installer to a latest version
...
The most recent version of Syncfusion JavaScript can be downloaded and installed by clicking on the "Latest Version: {Version}" link at the top of the Syncfusion JavaScript Control Panel.
