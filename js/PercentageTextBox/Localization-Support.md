...
{% include image.html url="/js/PercentageTextBox/Localization-Support_images/Localization-Support_img1.png" Caption="PercentageTextBox with de-DE locale"%}



{% include image.html url="/js/PercentageTextBox/Localization-Support_images/Localization-Support_img2.png" Caption="PercentageTextBox with en-US locale				"%}
