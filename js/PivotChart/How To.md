...
* [`Smart Labels`](/api/js/ejchart#members:primaryxaxis-labelintersectaction): You can customize the lables in a different view by given options mentioned in the following image.
