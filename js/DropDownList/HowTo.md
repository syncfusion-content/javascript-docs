...
ContextMenu can be added for DropDownList items by setting the class name of  DropDownList popupwrapper container as contextMenuTarget. Please refer to the following code.
