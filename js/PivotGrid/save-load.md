...
By using the current report name, storage option and url, you can save the current report of the PivotGrid to the database. The [`saveReport`](/api/js/ejpivotgrid#methods:savereport) method will help you to save the report.
