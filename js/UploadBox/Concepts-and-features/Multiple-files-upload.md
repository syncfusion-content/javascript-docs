...
{% include image.html url="/js/UploadBox/Concepts-and-features/Multiple-files-upload_images/Multiple-files-upload_img1.jpeg" Caption=""%}_**Note: The Multiple file selection supports all the latest versions of browser except Internet Explorer 9 and its previous versions.**_
...
{% include image.html url="/js/UploadBox/Concepts-and-features/Multiple-files-upload_images/Multiple-files-upload_img2.png" Caption="Figure 16: Enables multiple selections"%}



{% include image.html url="/js/UploadBox/Concepts-and-features/Multiple-files-upload_images/Multiple-files-upload_img3.png" Caption=" Figure 17: Uploadbox with multiple files       "%}
