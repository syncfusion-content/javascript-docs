...
{% include image.html url="/js/RangeNavigator/Populate-Data_images/Populate-Data_img1.png" Caption="RangeNavigator that is populated with data using dataSource property in series"%}
