...
{% include image.html url="/js/RichTextEditor/Concepts-and-Features/Insert-Video_images/Insert-Video_img1.png" Caption="Insert video popup"%}

> _**Note: Insert video option is enabled only in HTML5 support browsers.**_
