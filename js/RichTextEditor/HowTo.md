...
To increase the RTE content maximum word count, we suggest you to set the [maxLength](http://help.syncfusion.com/js/api/ejrte#members:maxlength) property for it. By default, maxLength value is 7000, assign it with a value based on your requirement. 

Refer the following API reference link: [Link](http://help.syncfusion.com/js/api/ejrte#members:maxlength) 
...
we can add separator in the RTE toolbar list. We have a property [“enableSeparator”](http://help.syncfusion.com/js/api/ejtoolbar#members:enableseparator) in the toolbar control. So we need to set this property as true by creating the object of toolbar in the “preRender” event of RTE as shown below code:
...
This requirement can have achieved by using [“cssClass”](http://help.syncfusion.com/js/api/ejrte#members:cssclass) API of RichTextEditor component. It is used to customize the default “CSS” styles of the control. Using this API to define our own custom “CSS” and images to overwrite the default “CSS” styles of the control. 
