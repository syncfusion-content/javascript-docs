...
When you are using WebAPI controller, refer to the “Datasource Initialization” section under the following [link](http://help.syncfusion.com/js/pivotclient/relational-getting-started#creating-a-simple-application-with-PivotClient-and-relational-datasource-server-mode).
