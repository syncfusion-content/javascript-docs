...
<link 
href="[http://cdn.syncfusion.com/13.1.0.21/js/web/flat-azure/ej.web.all.min.css](http://cdn.syncfusion.com/13.1.0.21/js/web/flat-azure/ej.web.all.min.css)"rel="stylesheet"/>
    <!--scripts-->
...
{% include image.html url="\js\ColorPicker\concepts-and-features\angular-binding_images\angular-binding_img1.png" Caption="Figure 2618: ColorPicker with Angular Support"%}
