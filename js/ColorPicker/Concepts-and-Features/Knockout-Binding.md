...
<script src="[http://cdn.syncfusion.com/13.1.0.21/js/ej.widget.ko.min.js](http://cdn.syncfusion.com/13.1.0.21/js/ej.widget.ko.min.js)">
</script>
</head>
<body>
...
{% include image.html url="/js/ColorPicker/Concepts-and-Features/Knockout-Binding_images/Knockout-Binding_img1.png" Caption="Figure 17: ColorPicker with KnockOut Support"%}
