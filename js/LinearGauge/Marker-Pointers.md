...
{% include image.html url="/js/LinearGauge/Marker-Pointers_images/Marker-Pointers_img1.png" Caption="Linear Gauge with marker pointer"%}
...
{% include image.html url="/js/LinearGauge/Marker-Pointers_images/Marker-Pointers_img2.png" Caption="Linear Gauge with customized pointer value"%}
...
{% include image.html url="/js/LinearGauge/Marker-Pointers_images/Marker-Pointers_img3.png" Caption="Linear Gauge with customized marker pointer"%}
...
{% include image.html url="/js/LinearGauge/Marker-Pointers_images/Marker-Pointers_img4.png" Caption="Linear Gauge with pointer position attribute"%}
...
{% include image.html url="/js/LinearGauge/Marker-Pointers_images/Marker-Pointers_img5.png" Caption="Linear Gauge with multiple marker pointers"%}
