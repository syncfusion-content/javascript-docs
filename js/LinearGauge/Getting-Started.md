...
* You can set the [`height`](../api/js/ejlineargauge#members:height) and [`width`](../api/js/ejlineargauge#members:width) of the gauge as shown in the following code example.
...
* You can draw the Thermometer by using [`labelColor`](../api/js/ejlineargauge#members:labelcolor) option and set animate property [`enableAnimation`](../api/js/ejlineargauge#members:enableanimation) as _True_.  
...
* You can change the Scale Style of Thermometer using [`type`](../api/js/ejlineargauge#members:scales-type) property.

* You can set the Minimum temperature up to -10 and maximum body temperature up to 110. 

* You can set the Minimum scale value as -10 by using [`minimum`](../api/js/ejlineargauge#members:scales-minimum) property and maximum value as 110 by using [`maximum`](..api/js/ejlineargauge#members:scales-maximum) property.

* You can set the Location values such as vertical and horizontal position by using [`position`](../api/js/ejlineargauge#members:scales-position) property in the thermometer.

* You can set the thermometer height by using [`length`](../api/js/ejlineargauge#members:scales-length) property.

* You can set the Minor Interval value as 5 to get the exact temperature of the patient by using [`minorIntervalValue`](../api/js/ejlineargauge#members:scales-majorintervalvalue) property.
...
* **Marker pointer** displays as a pointer device which shows the actual values. In this example, there is no need to show a marker pointer in a thermometer, therefore, you can hide it by setting the [`opacity`](../api/js/ejlineargauge#members:scales-markerpointers-opacity) property to ‘0’.

* **Bar pointer** displays as a mercury metal that shows the exact temperature of the person. You can set the basic properties of the bar pointer such as [`width`](../api/js/ejlineargauge#members:scales-barpointers-width), [`distanceFromScale`](../api/js/ejlineargauge#members:scales-barpointers-distancefromscale), [`value`](../api/js/ejlineargauge#members:scales-barpointers-value) and [`backgroundColor`](../api/js/ejlineargauge#members:scales-barpointers-backgroundcolor).
...
* You can use the scale labels to display the value by using [`labels`](../api/js/ejlineargauge#members:scales-labels) property in the gauge. You can customize the label [`placement`](../api/js/ejlineargauge#members:scales-labels-placement),[`font`](../api/js/ejlineargauge#members:scales-labels-font) (including its style and family) and its [`distanceFromScale`](../api/js/ejlineargauge#members:scales-labels-distancefromscale).
...
* You can set the [`width`](../api/js/ejlineargauge#members:scales-ticks-width) and [`height`](../api/js/ejlineargauge#members:scales-ticks-height) of the major ticks greater than the Minor ticks. You can set dark background for tick Color to have a better visibility.

* You can also use four [`ticks`](../api/js/ejlineargauge#members:scales-ticks) for both the sides, each having two minor ticks and major ticks.
...
* You can change the [`showCustomLabels`](../api/js/ejlineargauge#members:scales-showcustomlabels) property as **True** to show the custom labels.
