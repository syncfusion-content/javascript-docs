...
* Another valuable resource is the [API reference](http://help.syncfusion.com/api/js) which provides detailed information on the object hierarchy as well as the settings available on every object.
