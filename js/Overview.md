---
layout: post
title: Learn here about getting started with Syncfusion JavaScript, its elements, and more
...
* Another valuable resource is the [API reference](https://help.syncfusion.com/api/js/) which provides detailed information on the object hierarchy as well as the settings available on every object.
