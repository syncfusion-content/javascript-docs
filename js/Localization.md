...
I> **ej.globalize.min.js** library avails as built-in within ej.web.all.min.js file, therefore it is not necessary to externally refer it in your application (applicable for verison 13.4.0.53 and higher). For verison lower than 13.4.0.53, refer ej.globalize.min.js along with ej.web.all.min.js
