...
{% include image.html url="/js/OlapGauge/Frame-Type_images/Frame-Type_img1.png" Caption="Full Circle"%}
...
{% include image.html url="/js/OlapGauge/Frame-Type_images/Frame-Type_img2.png" Caption="Half Circle Frame Type"%}
