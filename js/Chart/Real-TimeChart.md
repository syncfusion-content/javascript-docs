...
Chart can be updated dynamically with real time data. Whenever you add a point or remove a point from the dataSource, you have to call [redraw](../api/ejchart#members:redraw) method to request chart to redraw its content.    
