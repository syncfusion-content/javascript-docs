...
description: Learn how to export Chart as excel file or image in Syncfusion Essential JavaScript Chart Control, its elements, and more.
platform: js
control: Chart
documentation: ug
api : /api/js/ejchart
...
![Multiple chart excel exporting in JavaScript](/js/Chart/Exporting_images/Exporting_img2.png)
...
![Rotating the chart in JavaScript](/js/Chart/Exporting_images/Exporting_img3.png)
