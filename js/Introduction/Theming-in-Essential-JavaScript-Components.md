...
The **Essential Studio** Suite provides a css file named **ej.web.all.min.css** for each of the above specified theme, which can be referred in your application, in order to apply the appropriate theming styles to the **EJ web components**. All the above specified theme files are available within the **css** folder which is depicted [here](http://helpjs.syncfusion.com/js/introduction/installation-and-deployment#assets).
...
{% include image.html url="/js/Introduction/Theming-in-Essential-JavaScript-Components_images/Theming-in-Essential-JavaScript-Components_img1.png" %}
...
{% include image.html url="/js/Introduction/Theming-in-Essential-JavaScript-Components_images/Theming-in-Essential-JavaScript-Components_img5.png" %}
...
The non-minified version of the css files are present within the **assets-src** folder, as mentioned earlier in this [section](http://helpjs.syncfusion.com/js/introduction/installation-and-deployment#src). 
...
{% include image.html url="/js/Introduction/Theming-in-Essential-JavaScript-Components_images/Theming-in-Essential-JavaScript-Components_img12.png" %}
