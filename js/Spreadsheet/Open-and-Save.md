...
To save Spreadsheet document as excel file, [`export`](http://help.syncfusion.com/js/api/ejspreadsheet#methods:xlexport-export "export") method should be called with file type as parameter. The code snippets to save Spreadsheet document are as follows,
