...
First, you need to define the service methods inside IPivotTreeMapService interface, found in `IPivotTreeMapService.cs` file, created while adding WCF Service to your Web Application.
...
Secondly, you need to elaborate the service methods inside the main class, found in `PivotTreeMapService.svc.cs` file 
...
N> In this example, “PivotTreeMapDemo” indicates the name and root namespace of the Web Application created in Visual Studio IDE and “PivotTreeMapService” indicates the name of the WCF service created.
