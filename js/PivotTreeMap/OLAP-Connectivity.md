...
First, you can define the service methods in the IOlapService interface. To do this, find the `IOlapService.cs` file which was created while adding the WCF service to your web application.
...
Then, you can elaborate the service methods in the main class, found in `OlapService.svc.cs` file.
...
N> The [`customObject`](/api/js/ejpivottreemap#members:customobject) utilized to pass additional information between the client-end and the service-end.
...
N> In this example, the “PivotTreeMapDemo” indicates the name and root namespace of the web application that is created in the Visual Studio IDE, and the “OlapService” indicates the name of the created WCF service.
