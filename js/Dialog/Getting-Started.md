...
{% include image.html url="/js/Dialog/Getting-Started_images/Getting-Started_img1.png" %}
...
{% include image.html url="/js/Dialog/Getting-Started_images/Getting-Started_img2.png" %}
...
{% include image.html url="/js/Dialog/Getting-Started_images/Getting-Started_img3.png" %}
...
{% include image.html url="/js/Dialog/Getting-Started_images/Getting-Started_img4.png" %}
...
<!-- insert the element at the end of the Sign up form -->
...
{% include image.html url="/js/Dialog/Getting-Started_images/Getting-Started_img5.png" %}
