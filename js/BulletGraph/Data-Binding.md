...
{% include image.html url="/js/BulletGraph/Data-Binding_images/Data-Binding_img1.png" Caption="Bullet Graph bounded to JSON data"%}
...
{% include image.html url="/js/BulletGraph/Data-Binding_images/Data-Binding_img2.png" Caption="Bullet Graph bounded to data from server"%}
