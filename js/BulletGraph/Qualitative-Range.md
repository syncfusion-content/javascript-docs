...
![Visual representation of Bullet Graph with different qualitative ranges and different colors in JavaScript](/js/BulletGraph/Qualitative-Range_images/Qualitative-Range_img1.png) 
