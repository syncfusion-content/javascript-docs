...
{% include image.html url="\js\BulletGraph\concepts-and-features\data-binding_images\data-binding_img1.png" Caption="Bullet Graph bounded to JSON data"%}
...
{% include image.html url="\js\BulletGraph\concepts-and-features\data-binding_images\data-binding_img2.png" Caption="Bullet Graph bounded to data from server"%}
