...
Click `Add` in the `Expression Dialog` to add a new expression column.
...
To include the function names and the column names in the `Expression` text area, double-click the specific name in respective lists.
