...
In **Tooltip** option, you can customize the Tooltip window by adding the tooltip template on that page with the help of API [`templateID`](../api/js/ejcirculargauge#members:tooltip-templateid). Refer to the following code example to know more about Tooltip template.
