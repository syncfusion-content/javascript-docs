...
Specifies the value for moving average.
...
* "none". See [TextOverflow](http://jsplayground.syncfusion.com/dwcvfzuv).
...
$("#container").ejChart({
    series : [{
             points:[ {showIntermediateSum : true }]
    }]                   
});
 {% endhighlight %} 
...
* "single". See <a href="global.html#members:Type">Type</a>
...
$("#container").ejChart({
series :[{selectionSettings:{type:"multiple"}}]                  
});
{% endhighlight %}
...
Try it: [JS Playground Sample](http://jsplayground.syncfusion.com)
