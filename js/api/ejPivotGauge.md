...
<ts name = "ej.olap.PivotGauge.NumberFormat"/>

Allows the user to change the format of the label values in PivotGauge.

#### Default Value: ej.olap.PivotGauge.NumberFormat.Default
...
$("#PivotGauge1").ejPivotGauge({ numberFormat: ej.olap.PivotGauge.NumberFormat.Default });
...
$("#PivotGauge1").ejPivotGauge({labelFormatSettings: {numberFormat: ej.olap.PivotGauge.NumberFormat.Default} });
...
<td class="type"><ts ref="ej.olap.PivotGauge.Model"/>object</td>
